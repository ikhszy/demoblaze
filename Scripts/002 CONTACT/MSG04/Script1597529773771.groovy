...
WebUI.setText(findTestObject('002 CONTACT/004 Input Name'), 'Muhammad Ikhsan')

WebUI.setText(findTestObject('002 CONTACT/005 Input Message'), 'Need help with my recent purchase')

WebUI.click(findTestObject('002 CONTACT/008 Button CancelXMessage'), FailureHandling.STOP_ON_FAILURE)

verif2 = WebUI.verifyElementNotVisibleInViewport(findTestObject('002 CONTACT/002 Label Pop Up'), 0)
