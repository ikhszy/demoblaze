...
boolean verif1 = WebUI.verifyElementPresent(findTestObject('001 HOME/018 img Item AppleMonitor'), 0)
...
if ((verif1 && verif2) && (verif3 == true)) {
    KeywordUtil.markPassed('Berhasil melihat detail item Monitor')

    WebUI.closeBrowser()
} else {
    KeywordUtil.markFailed('Gagal melihat detail item Monitor')
