...
WebUI.setText(findTestObject('004 CART/006 Input Country'), 'Wakanda')
...
WebUI.setText(findTestObject('004 CART/009 Input Month'), '08')

WebUI.setText(findTestObject('004 CART/010 Input Year'), '')
